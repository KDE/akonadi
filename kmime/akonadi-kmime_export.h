...
#     define AKONADI_KMIME_DEPRECATED_EXPORT AKONADI_KMIME_EXPORT
#     define AKONADI_KMIME_DEPRECATED
#   else
#     define AKONADI_KMIME_EXPORT_DEPRECATED KDE_DEPRECATED AKONADI_KMIME_EXPORT
#     define AKONADI_KMIME_DEPRECATED_EXPORT KDE_DEPRECATED AKONADI_KMIME_EXPORT
#     define AKONADI_KMIME_DEPRECATED KDE_DEPRECATED
#   endif
# endif
