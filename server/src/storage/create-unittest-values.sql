...
INSERT INTO Locations (id, uri, cachepolicy_id, resource_id, exists_count, recent_count, unseen_count, first_unseen, uid_validity) VALUES (0, '/foo', 1, 0, 3, 0, 0, 0, 0);
INSERT INTO Locations (id, uri, cachepolicy_id, resource_id, exists_count, recent_count, unseen_count, first_unseen, uid_validity) VALUES (1, '/foo/bar', 1, 0, 2, 0, 0, 0, 0);
INSERT INTO Locations (id, uri, cachepolicy_id, resource_id, exists_count, recent_count, unseen_count, first_unseen, uid_validity) VALUES (2, '/foo/bar/bla', 1, 0, 2, 0, 0, 0, 0);
INSERT INTO Locations (id, uri, cachepolicy_id, resource_id, exists_count, recent_count, unseen_count, first_unseen, uid_validity) VALUES (3, '/foo/bla', 1, 0, 0, 0, 0, 0, 0);
INSERT INTO Locations (id, uri, cachepolicy_id, resource_id, exists_count, recent_count, unseen_count, first_unseen, uid_validity) VALUES (4, '/foo2', 1, 1, 2, 3, 4, 5, 6);

DELETE FROM Resources;
INSERT INTO Resources (id, name, cachepolicy_id) VALUES(0, 'res1', 1);
INSERT INTO Resources (id, name, cachepolicy_id) VALUES(1, 'res2', 1);
INSERT INTO Resources (id, name, cachepolicy_id) VALUES(2, 'res3', 1);
