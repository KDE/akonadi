...
# 1.33, 1.33.0, 1.33.1, 1.34, 1.34.0, 1.34.1, 1.35, 1.35.0, 1.35.1, 1.36.0, 1.36.1, 1.37
#
...
SET( _boost_TEST_VERSIONS ${Boost_ADDITIONAL_VERSIONS} "1.37.0" "1.37" "1.36.1" "1.36.0" "1.35.1" "1.35.0" "1.35" "1.34.1" "1.34.0" "1.34" "1.33.1" "1.33.0" "1.33" )
...
ELSE (_boost_IN_CACHE)
  ...
  IF(Boost_INCLUDE_DIR)
    ...
    FOREACH(COMPONENT ${Boost_FIND_COMPONENTS})
      ...
      IF(NOT Boost_${COMPONENT}_FOUND)
	SET( Boost_ERROR_MESSAGE "${Boost_ERROR_MESSAGE}Component ${COMPONENT} not found. " )
        SET( Boost_FOUND FALSE)
      ENDIF(NOT Boost_${COMPONENT}_FOUND)
    ENDFOREACH(COMPONENT)
  ...
  ELSE (Boost_FOUND)
	...
	ELSE (Boost_FIND_VERSION_MAJOR)
          MESSAGE(STATUS "Boost Version found: ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}. ${Boost_ERROR_MESSAGE}")
