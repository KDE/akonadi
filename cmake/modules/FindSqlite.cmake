...
# SPDX-FileCopyrightText: 2010 Christophe Giboudeaux <cgiboudeaux@gmail.com>
...
if(PC_SQLITE_FOUND)
    find_path(SQLITE_INCLUDE_DIR NAMES sqlite3.h PATHS ${PC_SQLITE_INCLUDEDIR} NO_DEFAULT_PATH)

    find_library(SQLITE_LIBRARIES NAMES sqlite3 PATHS ${PC_SQLITE_LIBDIR} NO_DEFAULT_PATH)
...
if(UNIX)
    find_file(SQLITE_STATIC_LIBRARIES libsqlite3.a ${PC_SQLITE_LIBDIR})
else(UNIX)
    ...
    if(SQLITE_VERSION_OK)
        ...
        try_compile(
            ...
            LINK_LIBRARIES
                ${SQLITE_LIBRARIES}
            CMAKE_FLAGS
                "-DINCLUDE_DIRECTORIES:PATH=${SQLITE_INCLUDE_DIR}"
        )
        if(NOT SQLITE_HAS_UNLOCK_NOTIFY)
            message(
                STATUS
                "Sqlite ${SQLITE_VERSION} was found, but it is not compiled with -DSQLITE_ENABLE_UNLOCK_NOTIFY"
            )
        endif()
    endif()
endif()
