  ...
  public:
    ...
    bool testAndSetOnlineResources(const Akonadi::Collection& collection)
    {
      ...
      if ( !instance.isOnline() ) {
        if ( KMessageBox::questionYesNo( parentWidget, i18n( "Before to sync folder it's necessary to have resource online. Do you want to make it online ?" ), i18n( "Resources is offline" ) ) != KMessageBox::Yes )
          return false;
