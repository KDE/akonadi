...
#ifndef AKONADI_COLLECTIONDISPLAYATTRIBUTE_H
#define AKONADI_COLLECTIONDISPLAYATTRIBUTE_H
 ...
 * @since 4.2
 */
class AKONADI_EXPORT CollectionDisplayAttribute : public Attribute
{
  public:
    /**
    ...
    CollectionDisplayAttribute* clone() const;
