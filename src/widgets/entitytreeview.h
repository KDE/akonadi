...
public:
    ...
    /*!
     * \at true if we automatic sorting
     * \a active enables automatic sorting if set as \\ true
     * \since 4.8.1
     */
     ...
     *
     * \a name The name of the popup menu
     *
     * \since 4.9
     * \note For backwards compatibility, the default is the standard
     * collection popup menu, "akonadi_collectionview_contextmenu".
     * \sa KXMLGUIClient, KXMLGUIFactory::container()
     */
