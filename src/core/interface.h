 ...
 */
AKONADICORE_EXPORT
Task<Item::List> fetchItems(const Item::List &items, const ItemFetchOptions &options,
                            Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<Item::List> fetchItemsForTag(const Tag &tag, const ItemFetchOptions &options,
                                  Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<Item> createItem(const Item &item, const Collection &collection,
 ...
 */
AKONADICORE_EXPORT
Task<Item> updateItem(const Item &item, ItemModifyFlags flags = ItemModifyFlag::Default,
                      Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<Item::List> updateItems(const Item::List &items, ItemModifyFlags flags = ItemModifyFlag::Default,
                             Session *session = nullptr);
...
Task<void> moveItemsFromCollection(const Item::List &items, const Collection &source,
                                   const Collection &destination, Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<Collection::List> fetchCollectionsRecursive(const Collection::List &collections, const CollectionFetchOptions &options = {},
                                                 Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<void> moveCollection(const Collection &collection, const Collection &destination,
                          Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<void> copyCollection(const Collection &collection, const Collection &destination,
                          Session *session = nullptr);
 ...
 */
AKONADICORE_EXPORT
Task<CollectionStatistics> fetchCollectionStatistics(const Collection &collection,
                                                     Session *session = nullptr);
...
Task<Collection> createSearchCollection(const QString &name, const SearchQuery &searchQuery,
                                        const ItemSearchOptions &options, Session *session = nullptr);
