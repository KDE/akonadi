...
/*!
 * \brief Specifies which parts of an item should be fetched from the Akonadi storage.
 *
...
public:
    ...
    /*!
     * Creates a new item fetch scope from an \a other.
     */
     ...
     *
     * \a part The payload part identifier.
     *             Valid values depend on the item type.
     * \a fetch \\ true to fetch this part, \\ false otherwise.
     */
     ...
     *
     * \a fetch \\ true if the full payload should be fetched, \\ false otherwise.
     */
     ...
     * The default is \\ false.
     *
     * \a fetch \\ true if all available attributes should be fetched, \\ false otherwise.
     */
     ...
     * from the local cache.
     *
     * \a cacheOnly \\ true if no remote data should be requested,
     ...
     * requested payload is in the cache. Calling it calls \sa setCacheOnly with true automatically.
     ...
     *
     * \sa setCheckForCachedPayloadPartsOnly()
     *
     * \since 4.11
     */
     ...
     *
     * \a ancestorDepth The desired ancestor retrieval depth.
     * \since 4.4
     */
     ...
     *
     * \a retrieveMtime \\ true to retrieve the modification time, \\ false otherwise
     * \since 4.6
     */
     ...
     *
     * \a retrieveGID \\ true to retrieve the GID, \\ false otherwise
     * \since 4.12
     */
     ...
     * modified after \a changedSince timestamp.
     *
     * \a changedSince The timestamp of oldest modified item to fetch
     * \since 4.11
     */
     ...
     *
     * \a retrieveRid whether or not to load remote identification.
     * \since 4.12
     */
     ...
     *
     * \sa setFetchRemoteIdentification()
     * \since 4.12
     */
     ...
     * The default is \\ false.
     *
     * \a fetchTags whether or not to load tags.
     * \since 4.13
     */
     ...
     *
     * \a fetchVRefs whether or not to fetch virtualc references
     * \since 4.14
     */
