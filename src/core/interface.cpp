...
Task<Item> createItem(const Item &item, const Collection &collection, ItemCreateFlags flags,
                      Session *session)
{
...
Task<Collection::List> fetchCollectionsRecursive(const Collection::List &baseList, const CollectionFetchOptions &options,
                                                 Session *session)
{
