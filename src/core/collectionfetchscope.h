...
/*!
 * \brief Specifies which parts of a collection should be fetched from the Akonadi storage.
 *
...
public:
    ...
    /*!
     * Creates a new collection fetch scope from an \a other.
     */
     ...
     *
     * \a include \\ true to include collection statistics, \\ false otherwise (the default).
     */
     ...
     *
     * \a mimeTypes A list of mime types
     */
