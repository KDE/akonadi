...
class AKONADIPRIVATE_EXPORT NotificationMessageV3 : public Akonadi::NotificationMessageV2
{
public:
...
AKONADIPRIVATE_EXPORT QDebug operator<<(QDebug dbg, const Akonadi::NotificationMessageV3 &msg);
